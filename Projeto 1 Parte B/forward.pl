...
% write('De acordo com as opcoes por si escolhidas encontramos o seguinte
% Transporte: '),resultadowrite(P), nl,
assert(fact(P)),

demo. % Continue

demo:- %write( 'Nao existem outros transportes...'),
nl. % All facts derived
