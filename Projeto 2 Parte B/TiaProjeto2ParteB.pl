...
custo([_],[],0).
custo([A,B|C],[T|T2],Cust):- dist(B,A,T,Dist1,Temp1), custo([B|C],T2,Cust2), Cust is Dist1*Temp1 + Cust2.
...
questao2(A1):- write("Para onde vai?"),nl,nl,
        ...
        (
            ...
            (A2 == 7),caminhocurto(A1,braga,_,C,_)),nl,write('Custo e Tempo: '), write(C).
